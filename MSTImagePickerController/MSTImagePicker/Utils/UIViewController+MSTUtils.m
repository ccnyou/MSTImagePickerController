...
- (void)addNavigationRightCancelButton {
    UIBarButtonItem *right = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel
                                                                           target:self
                                                                           action:@selector(mp_cancelButtonDidClicked)];
...
- (UIAlertController *)addAlertControllerWithTitle:(NSString *)title actionTitle:(NSString *)actionTitle {
    UIAlertController *alertCtrler = [UIAlertController alertControllerWithTitle:title
                                                                         message:nil
