...
- (void)setAsset:(MSTAssetModel *)asset {
    ...
    [[MSTPhotoManager defaultManager] getThumbnailImageFromPHAsset:asset.asset
                                                        photoWidth:self.contentView.mst_width
                                                   completionBlock:^(UIImage *result, NSDictionary *info) {
    ...
    if (asset.type == MSTAssetModelMediaTypeVideo) {
        ...
        self.videoLengthLabel.text = [NSString stringWithFormat:@"%d:%02d",
                                                                (int)asset.videoDuration / 60,
                                                                (int)asset.videoDuration % 60];
...
- (UIImageView *)imageView {
    if (!_imageView) {
        ...
        NSLayoutConstraint *top = [NSLayoutConstraint constraintWithItem:_imageView
        ...
        NSLayoutConstraint *trailing = [NSLayoutConstraint constraintWithItem:_imageView
                                                                   ...
                                                                   multiplier:1
                                                                     constant:0];
        NSLayoutConstraint *bottom = [NSLayoutConstraint constraintWithItem:_imageView
...
- (UIImageView *)videoLengthBgView {
    if (!_videoLengthBgView) {
        ...
        NSLayoutConstraint *top = [NSLayoutConstraint constraintWithItem:_videoLengthBgView
                                                               attribute:NSLayoutAttributeTop
                                                               relatedBy:NSLayoutRelationEqual
                                                                  toItem:self.contentView
                                                               attribute:NSLayoutAttributeBottom
                                                              multiplier:1
                                                                constant:-24];
        NSLayoutConstraint *leading = [NSLayoutConstraint constraintWithItem:_videoLengthBgView
                                                                   attribute:NSLayoutAttributeLeading
                                                                   relatedBy:NSLayoutRelationEqual
                                                                      toItem:self.contentView
                                                                   attribute:NSLayoutAttributeLeading
                                                                  multiplier:1
                                                                    constant:0];
        NSLayoutConstraint *trailing = [NSLayoutConstraint constraintWithItem:_videoLengthBgView
                                                                    attribute:NSLayoutAttributeTrailing
                                                                    relatedBy:NSLayoutRelationEqual
                                                                       toItem:self.contentView
                                                                    attribute:NSLayoutAttributeTrailing
                                                                   multiplier:1
                                                                     constant:0];
        NSLayoutConstraint *bottom = [NSLayoutConstraint constraintWithItem:_videoLengthBgView
                                                                  attribute:NSLayoutAttributeBottom
                                                                  relatedBy:NSLayoutRelationEqual
                                                                     toItem:self.contentView
                                                                  attribute:NSLayoutAttributeBottom
...
- (UILabel *)videoLengthLabel {
    if (!_videoLengthLabel) {
        ...
        NSLayoutConstraint *trailing = [NSLayoutConstraint constraintWithItem:_videoLengthLabel
                                                                    attribute:NSLayoutAttributeTrailing
                                                                    relatedBy:NSLayoutRelationEqual
                                                                       toItem:self.videoLengthBgView
                                                                    attribute:NSLayoutAttributeTrailing
                                                                   multiplier:1
                                                                     constant:-5];
        NSLayoutConstraint *centerY = [NSLayoutConstraint constraintWithItem:_videoLengthLabel
                                                                  ...
                                                                  multiplier:1
                                                                    constant:3];
        NSLayoutConstraint *leading = [NSLayoutConstraint constraintWithItem:_videoLengthLabel
                                                                   attribute:NSLayoutAttributeLeading
                                                                   relatedBy:NSLayoutRelationEqual
                                                                      toItem:self.videoBadgeImageView
                                                                   attribute:NSLayoutAttributeTrailing
                                                                  multiplier:1
                                                                    constant:0];
...
- (UIImageView *)videoBadgeImageView {
    if (!_videoBadgeImageView) {
        ...
        NSLayoutConstraint *leading = [NSLayoutConstraint constraintWithItem:_videoBadgeImageView
                                                                   attribute:NSLayoutAttributeLeading
                                                                   relatedBy:NSLayoutRelationEqual
                                                                      toItem:self.videoLengthBgView
                                                                   attribute:NSLayoutAttributeLeading
                                                                  multiplier:1
                                                                    constant:3.f];
        NSLayoutConstraint *height = [NSLayoutConstraint constraintWithItem:_videoBadgeImageView
                                                                 ...
                                                                 multiplier:1
                                                                   constant:15];
        NSLayoutConstraint *width = [NSLayoutConstraint constraintWithItem:_videoBadgeImageView
                                                                ...
                                                                multiplier:1
                                                                  constant:20];
        NSLayoutConstraint *centerY = [NSLayoutConstraint constraintWithItem:_videoBadgeImageView
                                                                   attribute:NSLayoutAttributeCenterY
                                                                   relatedBy:NSLayoutRelationEqual
                                                                      toItem:self.videoLengthBgView
                                                                   attribute:NSLayoutAttributeCenterY
...
- (UIButton *)selectButton {
    if (!_selectButton) {
        ...
        MSTPhotoConfiguration *config = [MSTPhotoConfiguration defaultConfiguration];
        [_selectButton setImage:config.photoNormal ? config.photoNormal : [UIImage imageNamed:@"icon_picture_normal"]
                       forState:UIControlStateNormal];
        [_selectButton setImage:config.photoSelected ? config.photoSelected : [UIImage imageNamed:@"icon_picture_selected"]
                       forState:UIControlStateSelected];
        [_selectButton setImageEdgeInsets:UIEdgeInsetsMake(1, 1, 1, 1)];

        [_selectButton addTarget:self
                          action:@selector(mp_selectButtonDidSelected:)
                forControlEvents:UIControlEventTouchUpInside];

        [self.contentView addSubview:_selectButton];

        NSLayoutConstraint *trailing = [NSLayoutConstraint constraintWithItem:_selectButton
                                                                    attribute:NSLayoutAttributeTrailing
                                                                    relatedBy:NSLayoutRelationEqual
                                                                       toItem:self.contentView
                                                                    attribute:NSLayoutAttributeTrailing
                                                                   multiplier:1
                                                                     constant:0];
        NSLayoutConstraint *top = [NSLayoutConstraint constraintWithItem:_selectButton
                                                               attribute:NSLayoutAttributeTop
                                                               relatedBy:NSLayoutRelationEqual
                                                                  toItem:self.contentView
                                                               attribute:NSLayoutAttributeTop
                                                              multiplier:1
                                                                constant:0];
        NSLayoutConstraint *width = [NSLayoutConstraint constraintWithItem:_selectButton
                                                                 attribute:NSLayoutAttributeLeading
                                                                 relatedBy:NSLayoutRelationEqual
                                                                    toItem:self.contentView
                                                                 attribute:NSLayoutAttributeTrailing
                                                                multiplier:1
                                                                  constant:-self.frame.size.width / 3.f];
        NSLayoutConstraint *height = [NSLayoutConstraint constraintWithItem:_selectButton
                                                                  attribute:NSLayoutAttributeWidth
                                                                  relatedBy:NSLayoutRelationEqual
...
- (UIImageView *)maskingImageView {
    if (!_maskingImageView) {
        ...
        NSLayoutConstraint *top = [NSLayoutConstraint constraintWithItem:_maskingImageView
                                                               attribute:NSLayoutAttributeTop
                                                               relatedBy:NSLayoutRelationEqual
                                                                  toItem:self.contentView
                                                               attribute:NSLayoutAttributeTop
                                                              multiplier:1
                                                                constant:0];
        NSLayoutConstraint *leading = [NSLayoutConstraint constraintWithItem:_maskingImageView
                                                                   attribute:NSLayoutAttributeLeading
                                                                   relatedBy:NSLayoutRelationEqual
                                                                      toItem:self.contentView
                                                                   attribute:NSLayoutAttributeLeading
                                                                  multiplier:1
                                                                    constant:0];
        NSLayoutConstraint *trailing = [NSLayoutConstraint constraintWithItem:_maskingImageView
                                                                    attribute:NSLayoutAttributeTrailing
                                                                    relatedBy:NSLayoutRelationEqual
                                                                       toItem:self.contentView
                                                                    attribute:NSLayoutAttributeTrailing
                                                                   multiplier:1
                                                                     constant:0];
        NSLayoutConstraint *bottom = [NSLayoutConstraint constraintWithItem:_maskingImageView
                                                                  attribute:NSLayoutAttributeBottom
                                                                  relatedBy:NSLayoutRelationEqual
                                                                     toItem:self.contentView
                                                                  attribute:NSLayoutAttributeBottom
...
- (MSTCameraView *)cameraView {
    if (!_cameraView) {
        ...
        NSLayoutConstraint *top = [NSLayoutConstraint constraintWithItem:_cameraView
                                                               attribute:NSLayoutAttributeTop
                                                               relatedBy:NSLayoutRelationEqual
                                                                  toItem:self.contentView
                                                               attribute:NSLayoutAttributeTop
                                                              multiplier:1
                                                                constant:0];
        NSLayoutConstraint *leading = [NSLayoutConstraint constraintWithItem:_cameraView
                                                                   attribute:NSLayoutAttributeLeading
                                                                   relatedBy:NSLayoutRelationEqual
                                                                      toItem:self.contentView
                                                                   attribute:NSLayoutAttributeLeading
                                                                  multiplier:1
                                                                    constant:0];
        NSLayoutConstraint *trailing = [NSLayoutConstraint constraintWithItem:_cameraView
                                                                    attribute:NSLayoutAttributeTrailing
                                                                    relatedBy:NSLayoutRelationEqual
                                                                       toItem:self.contentView
                                                                    attribute:NSLayoutAttributeTrailing
                                                                   multiplier:1
                                                                     constant:0];
        NSLayoutConstraint *bottom = [NSLayoutConstraint constraintWithItem:_cameraView
                                                                  attribute:NSLayoutAttributeBottom
                                                                  relatedBy:NSLayoutRelationEqual
                                                                     toItem:self.contentView
                                                                  attribute:NSLayoutAttributeBottom
